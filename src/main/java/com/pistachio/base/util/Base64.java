...
public class Base64
{
    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options)
    {
        ...
        {
            logger.error("对象base64编码出错，return null", e);
            return null;
        } // end catch
        finally
        {
        ...
        {
            logger.error("不支持的编码格式，返回默认编码格式的字符串", uue);
    ...
    public static String encodeBytes(byte[] source, int off, int len, int options)
    {
        ...
        if ( gzip == GZIP )
        {
            ...
            {
                logger.error("字节数组base64编码出错，return null", e);
                return null;
            } // end catch
            finally
            {
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, int options)
    {
        ...
        else
        {
            ...
            catch (Exception e)
            {
                ...
                logger.error("base64解码出错，返回-1", e);
                return -1;
            } // end catch
        }
    } // end decodeToBytes
    ...
    public static byte[] decode(String s, int options)
    {
        ...
        {
            logger.error("不支持的编码格式，使用默认编码格式", uee);
            bytes = s.getBytes();
        } // end catch
        //</change>
    ...
    public static Object decodeToObject(String encodedObject)
    {
        ...
        {
            logger.error("base64解码出错，return null", e);
            obj = null;
        } // end catch
        catch (ClassNotFoundException e)
        {
            logger.error("没有找到base64解码对象的类，return null", e);
            obj = null;
        } // end catch
        finally
        {
    ...
    public static boolean encodeFileToFile(String infile, String outfile)
    {
        ...
        {
            logger.error("读写文件出错，return false", exc);
        }
        finally
        {
            try
