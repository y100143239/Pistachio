...
public final class Regexp
{
     ...
     */
    private static HashMap regexpHash = new HashMap();

    /**
     * 存放各种正规表达式(以key->value的形式)
     */
    private static List matchingResultList = new ArrayList();
    ...
    public String getRegexpHash(String regexpName)
    {
        ...
        {
            logger.info("在regexpHash中没有此["+regexpName+"]正规表达式");
            return "";
        }
    }
    ...
    public static boolean isHardRegexpValidate(String source, String regexp)
    {
        ...
        {
            logger.error("错误的正则表达式："+regexp, e);
        }
        return false;
    }
    ...
    public static HashMap getRegexpHash()
    {
        return regexpHash;
    }


    public static void setRegexpHash(HashMap regexpHash)
    {
        Regexp.regexpHash = regexpHash;
    }


    public static List getMatchingResultList()
    {
        return matchingResultList;
    }


    public static void setMatchingResultList(List matchingResultList)
    {
        Regexp.matchingResultList = matchingResultList;
    }
